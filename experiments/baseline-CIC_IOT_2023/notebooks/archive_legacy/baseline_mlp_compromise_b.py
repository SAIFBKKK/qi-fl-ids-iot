"""
baseline_mlp_compromise_b.py
============================

Baseline centralisé MLP — Architecture B
----------------------------------------
Architecture:
    32 -> 128 -> 64 -> 34
...
Objectif
--------
Entraîner directement un MLP plus expressif que l'architecture A,
tout en restant raisonnable pour un futur passage vers FL / IoT edge.
...
- Cette architecture est le meilleur compromis recommandé pour ton projet.
"""
...
OUTPUT_DIR = Path(r"E:\dataset\processed_merged_full\baseline_mlp_b_results")
LABEL_COL = "label"
...
def main():
    ...
    if SAVE_PLOTS:
        save_confusion_matrix(cm, OUTPUT_DIR / "confusion_matrix_test.png", "Confusion Matrix — MLP Architecture B (32 -> 128 -> 64 -> 34)")
