"""
train_level2_family_mlp.py
==========================

Level 2 hierarchical IDS training script.

Task:
- classify attack families

Reads prepared artifacts from:
E:\dataset\processed_merged_full\hierarchical_prepared\family

Saves model and metrics to:
E:\dataset\processed_merged_full\hierarchical_models\level2_family
"""
...
OUTPUT_DIR = Path(r"E:\dataset\processed_merged_full\hierarchical_models\level2_family")
