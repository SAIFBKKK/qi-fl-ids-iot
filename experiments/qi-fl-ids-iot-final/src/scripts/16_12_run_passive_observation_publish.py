...
def missing_scapy_result() -> dict[str, Any]:
    return {
        "ok": False,
        "phase": "P16.12",
        "error": "missing_dependency",
        "dependency": "scapy",
        "message": "Passive live observation requires Scapy in the Python environment used by sudo.",
        "recommended_vm_fix": [
            "sudo apt update",
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not scapy_available():
        print(json.dumps(missing_scapy_result(), indent=2))
        return 2
