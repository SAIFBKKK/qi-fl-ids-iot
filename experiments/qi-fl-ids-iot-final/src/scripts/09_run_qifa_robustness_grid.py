"""Run a light robustness grid for QIFA."""
...
def main() -> int:
    ...
    for alpha in config["scenarios"]["robustness"]["alphas"]:
        run_qifa_smoke_subprocess(
            config_path=args.config,
            alpha=float(alpha),
            clients=int(config["scenarios"]["robustness"]["clients"]),
        ...
        print(f"P9 robustness smoke completed | alpha={alpha}")
    return 0
